...
--- Q3. Which are the best 5 products with the highest average review rating?
...
---Q7. Segment customers into New, Returning, and Loayl based on their total 
...
---Q8. What are the top 3 most purchases products with each category?
with item_counts as (
select category,
item_purchased,
